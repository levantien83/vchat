...
**vChat** is a Ruby on Rails blog application that allows users to send messages to each other that can only be read once.
...
![Video Walkthrough](https://github.com/levantien83/vchat/blob/master/walkthrough_chat.gif)
